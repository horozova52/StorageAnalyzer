        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BackupLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    EnableAutoCleanup = table.Column<bool>(type: "bit", nullable: false),
                    EnableDuplicateDetection = table.Column<bool>(type: "bit", nullable: false),
                    EnableBackup = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DuplicateSetId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Files", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Files_DuplicateSets_DuplicateSetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScanLogs_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScanLogs_ScanSessions_ScanSessionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BackupLogs_UserId",
                table: "BackupLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Files_DuplicateSetId",
                table: "Files",
                column: "DuplicateSetId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScanLogs_FolderId",
                table: "ScanLogs",
                column: "FolderId");

            migrationBuilder.CreateIndex(
                name: "IX_ScanLogs_ScanSessionId",
                table: "ScanLogs",
